                ...
                <div class="iq-card-body p-0">
                  <div class="iq-thumb">
                    ...
                    <a href="music-player.php">
                      <img src="images/es.png" class="img-border-radius img-fluid w-100" alt="" />
                    </a>
              ...
              <div class="iq-card">
                <div class="iq-card-body p-0">
                  <div class="iq-thumb">
                    <div class="iq-music-overlay"></div>
                    <a href="music-player.php">
                      <img src="images/ar.png" class="img-border-radius img-fluid w-100" alt="" />
                    </a>
                    <div class="overlay-music-icon">
                      <a href="music-player.php">
                        <i class="las la-play-circle"></i>
              ...
              <div class="iq-card">
                <div class="iq-card-body p-0">
                  <div class="iq-thumb">
                    <div class="iq-music-overlay"></div>
                    <a href="music-player.php">
                      <img src="images/fr.png" class="img-border-radius img-fluid w-100" alt="" />
                    </a>
                    <div class="overlay-music-icon">
                      <a href="music-player.php">
                        <i class="las la-play-circle"></i>
              ...
              <div class="iq-card">
                <div class="iq-card-body p-0">
                  <div class="iq-thumb">
                    <div class="iq-music-overlay"></div>
                    <a href="music-player.php">
                      <img src="images/en.png" class="img-border-radius img-fluid w-100" alt="" />
                    </a>
                    <div class="overlay-music-icon">
                      <a href="music-player.php">
                        <i class="las la-play-circle"></i>
                    ...
                    <ul class="list-unstyled iq-song-slide mb-0 realeases-banner">
                      ...
                      <li class="active row">
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="media align-items-center col-10 col-md-5">
                            <div class="iq-realese-song">
                              <a href="music-player.php"><img src="images/en.png" class="img-border-radius avatar-60 img-fluid" alt="" /></a>
                            </div>
                            <div class="media-body text-white ml-3">
