            ...
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li>
                    ...
                    <ul id="dashboard" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li>
                            <a href="index.html"><i class="las la-house-damage"></i>Home</a>
                        </li>
                        <li>
                            <a href="latest.html"><i class="las la-headphones"></i>Latest</a>
                        </li>
                        <li>
                            <a href="albums.html"><i class="lar la-file-audio"></i>Radio</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="admin" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li>
                            <a href="admin-dashboard.html"><i class="las la-house-damage"></i>Dashboard</a>
                        </li>
                        <li>
                            <a href="admin-category.html"><i class="ri-function-line"></i>Category</a>
                        </li>
                        <li>
                            <a href="admin-author.html"><i class="las la-user"></i>Writer</a>
                        </li>
                        <li>
                ...
                <li>
                    <a href="Radio.html" class="iq-waves-effect"><i class="las la-calendar iq-arrow-left"></i><span>Radion</span></a>
                </li>
                <li>
                    <a href="Games.html" class="iq-waves-effect"><i class="las la-calendar iq-arrow-left"></i><span>Games</span></a>
                </li>
                <li>
                    <a href="rooms.html" class="iq-waves-effect"><i class="las la-calendar iq-arrow-left"></i><span>Chat room</span></a>
                </li>
            </ul>
        </nav>
    </div>
